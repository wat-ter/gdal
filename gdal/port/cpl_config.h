...
#endif // RTC_COCOA_FAMILY

// -----------------------------------------------------------------------------

#ifdef RTC_LINUX_ANDROID
#if defined(__ARM_ARCH) && (__ARM_ARCH == 7) || defined(__i386) // armv7/x86
/* Define if you want to use pthreads based multiprocessing support */
#define CPL_MULTIPROC_PTHREAD 1
...
#endif // RTC_LINUX_ANDROID

// -----------------------------------------------------------------------------

#ifdef RTC_LINUX_DESKTOP
/* Define if you want to use pthreads based multiprocessing support */
#define CPL_MULTIPROC_PTHREAD 1
...
#endif // RTC_LINUX_DESKTOP

// -----------------------------------------------------------------------------

#ifdef RTC_WINDOWS_FAMILY
...
/* RTC */
#undef _UNICODE // undefine UNICODE since gdal does not support it
#undef UNICODE

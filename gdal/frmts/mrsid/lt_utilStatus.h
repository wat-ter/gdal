...
LT_STATUSSTRING_ADD(LT_STS_BadParam, "bad function parameter")
LT_STATUSSTRING_ADD(LT_STS_BadContext, "bad calling context")
LT_STATUSSTRING_ADD(LT_STS_ForeignError, "3rd-party library error")
LT_STATUSSTRING_ADD(LT_STS_NotReached, "unreachable code")
LT_STATUSSTRING_ADD(LT_STS_NullPointer, "NULL pointer dereferenced")
LT_STATUSSTRING_ADD(LT_STS_OutOfMemory, "out of memory")
LT_STATUSSTRING_ADD(LT_STS_Unimplemented, "not implemented")
LT_STATUSSTRING_ADD(LT_STS_NoEncryption, "this SDK does not support decoding password protected MrSID files")
...
#define LTUTIL_STS_ERR_STAT_FAIL                 3038
LT_STATUSSTRING_ADD(LTUTIL_STS_ERR_STAT_FAIL, "stat error")
#define LTUTIL_STS_ERR_CHMOD_FAIL                 3039
LT_STATUSSTRING_ADD(LTUTIL_STS_ERR_CHMOD_FAIL, "chmod error")

...
public:
   ...
   LTISceneBuffer(LTISceneBuffer &&other) noexcept;
   LTISceneBuffer &operator=(LTISceneBuffer &&other) noexcept;
#endif
...
public:
   ...
   LT_STATUS initialize(const LTIPixel &pixelProps,
                        lt_uint32 numCols,
                        lt_uint32 numRows,
                        void **bsqData,
                        lt_uint32 totalNumCols = 0);
   ...
   LTISceneBuffer(const LTISceneBuffer &original,
                  ...
                  lt_uint32 numCols,
                  lt_uint32 numRows);
   LT_STATUS initialize(const LTISceneBuffer &original,
                        lt_uint32 colOffset,
                        lt_uint32 rowOffset,
                        lt_uint32 numCols,
                        lt_uint32 numRows);
   ...
   LT_STATUS realloc(lt_uint32 numCols, lt_uint32 numRows);

...
public:
  ...
  /**
    ...
    */
   static double snapToOctave(double mag, double threshold = LTI_DEFAULT_MAG_SNAP_THRESHOLD);
  ...
  /**
    ...
    * @return  the magnification rounded to an octave
    */
   static double snapToOctave(double mag, const LTIImage &imageStage, double threshold = LTI_DEFAULT_MAG_SNAP_THRESHOLD);
    ...
    */
   static lt_uint8 getNumLevelsForIcon(lt_uint32 width,
                                       lt_uint32 height,
                                       lt_uint32 iconsize);
    ...
    */
   static double getMagForIcon(lt_uint32 width,
                               lt_uint32 height,
                               lt_uint32 iconsize);

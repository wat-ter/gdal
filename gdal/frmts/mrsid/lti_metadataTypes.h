...
typedef enum LTIMetadataTag
{
   ...
   LTI_METADATA_TAG_IMAGE__MODIFICATIONS                 = 140,   /* ascii */
   LTI_METADATA_TAG_IMAGE__ENCODING_COMMENT              = 141,   /* ascii */
   LTI_METADATA_TAG_IMAGE__FORMAT                        = 142,   /* ascii */
   LTI_METADATA_TAG_IMAGE__QUANTIZATION_SCALE            = 143,   /* float vector */
   LTI_METADATA_TAG_IMAGE__PRINT_X_DENSITY               = 144,   /* float */
   LTI_METADATA_TAG_IMAGE__PRINT_Y_DENSITY               = 145,   /* float */
   LTI_METADATA_TAG_IMAGE__PRINT_DENSITY_UNIT            = 146,   /* ascii ('in' or 'cm') */
 ...
 *
 * These enums are used to represent the different classes of metadata
 * tags -- "classical", USER, GeoTIFF, etc.
 */
typedef enum LTIMetadataTagClass
{
...
typedef enum LTIMetadataDataType
{
  ...
  // not supported by classical metadata
